...
(
  ...
  // Upstream code expects a clear signal for some HCI blocks.
  // In the full SoC, this is typically tied to a peripheral reset/clear.
  // For this standalone functional build, keep it inactive.
  logic clear_i;
  assign clear_i = 1'b0;

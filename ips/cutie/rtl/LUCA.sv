...
`include "../../common_cells/fifo_v3.sv"
...
module LUCA
  #(
   ...
   // `layer_t` is a packed struct, so direct assignment preserves field layout.
   // The streaming-operator form was corrupting layer fields in simulation
   // (for example NI=1 turning into 33 after the FIFO round-trip).
   ...
   always_comb begin
      current_layer_done_d = current_layer_done_q;

  ...
  #(
   ...
   generate
      for (n=0; n<BRANCHNUM-1; n++ ) begin
         popcount
             #(
               .INPUT_WIDTH(TREEWIDTH))
         popc_i(
                .data_i(partial_bitvec[n]),
                .popcount_o(partial_sums[n])
                );
      ...
      if (REM != 0) begin
         ...
         popcount
           #(
             .INPUT_WIDTH(REM))
         popc_i(
                .data_i(partial_bitvec[BRANCHNUM-1][REM-1:0]),
                .popcount_o(partial_rem_sums)
                );
         ...
         popcount
           #(
             .INPUT_WIDTH(TREEWIDTH))
         popc_i(
                .data_i(partial_bitvec[BRANCHNUM-1][TREEWIDTH-1:0]),
                .popcount_o(partial_sums[BRANCHNUM-1])
                );

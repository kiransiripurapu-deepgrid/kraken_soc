...
SNE_EVENT_STREAM evt_stream_time_cut(.clk_i(engine_clk_i));
...
spill_register #(
	.T(uevent_t),
	.Bypass(1'b0)
) i_evt_time_stream_cut (
	.clk_i  (engine_clk_i),
	.rst_ni (engine_rst_ni),
	.valid_i(evt_stream_time_src.valid),
	.ready_o(evt_stream_time_src.ready),
	.data_i (evt_stream_time_src.evt),
	.valid_o(evt_stream_time_cut.valid),
	.ready_i(evt_stream_time_cut.ready),
	.data_o (evt_stream_time_cut.evt)
);
...
evt_time_unit #(.ENGINE_ID(ENGINE_ID))i_evt_time_unit (
	...
	.evt_stream_time_dst(evt_stream_time_cut),

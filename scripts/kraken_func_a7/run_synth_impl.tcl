################################################################################
# Vivado Synthesis & Implementation Script for kraken_func_a7
...
set project_path [file normalize [file join $script_dir DeepGrid_D100.xpr]]
...
set latch_rf_path [file normalize [file join $repo_root ips cv32e40p cv32e40p_register_file_latch.sv]]
set ff_rf_path    [file normalize [file join $repo_root ips cv32e40p cv32e40p_register_file_ff.sv]]
set xdc_path      [file normalize [file join $repo_root constraints kraken_soc_func_synth.xdc]]
set fpga_top_path [file normalize [file join $repo_root rtl kraken_soc_func_fpga.sv]]
set actmem_latch_path [file normalize [file join $repo_root ips cutie rtl sram_actmem_latch.sv]]
set weightmem_latch_path [file normalize [file join $repo_root ips cutie rtl sram_weightmem_latch.sv]]
set weightbuf_latch_path [file normalize [file join $repo_root ips cutie rtl weightbufferblock_latch.sv]]
set actmem_beh_path [file normalize [file join $repo_root ips cutie rtl sram_actmem_behavioural.sv]]
set weightmem_beh_path [file normalize [file join $repo_root ips cutie rtl sram_weightmem_behavioural.sv]]
set weightbuf_ff_path [file normalize [file join $repo_root ips cutie rtl weightbufferblock.sv]]
set prim_subreg_path [file normalize [file join $repo_root DeepGrid_D100.srcs sources_1 new prim_subreg.sv]]
set sne_evt_fifo_path [file normalize [file join $repo_root DeepGrid_D100.srcs sources_1 new sne_evt_fifo.sv]]

set latch_rf_file [ensure_file_in_fileset sources_1 $latch_rf_path]
set ff_rf_file    [ensure_file_in_fileset sources_1 $ff_rf_path]
set xdc_file      [ensure_file_in_fileset constrs_1 $xdc_path]
set fpga_top_file [ensure_file_in_fileset sources_1 $fpga_top_path]
set actmem_latch_file [ensure_file_in_fileset sources_1 $actmem_latch_path]
set weightmem_latch_file [ensure_file_in_fileset sources_1 $weightmem_latch_path]
set weightbuf_latch_file [ensure_file_in_fileset sources_1 $weightbuf_latch_path]
set actmem_beh_file [ensure_file_in_fileset sources_1 $actmem_beh_path]
set weightmem_beh_file [ensure_file_in_fileset sources_1 $weightmem_beh_path]
set weightbuf_ff_file [ensure_file_in_fileset sources_1 $weightbuf_ff_path]
...
disable_file_list_for_fpga [list \
    [file normalize [file join $repo_root ips register_interface axi_lite_to_reg.sv]] \
    [file normalize [file join $repo_root ips register_interface axi_to_reg_v2.sv]] \
    [file normalize [file join $repo_root ips register_interface reg_cdc.sv]] \
    [file normalize [file join $repo_root ips register_interface reg_to_axi.sv]] \
    [file normalize [file join $repo_root ips common_cells stream_xbar.sv]] \
    [file normalize [file join $repo_root ips common_cells deprecated rrarbiter.sv]] \
    [file normalize [file join $repo_root ips common_cells deprecated prioarbiter.sv]] \
]
enable_file_list_for_fpga [list \
    [file normalize [file join $repo_root ips common_cells cdc_2phase.sv]] \
    [file normalize [file join $repo_root ips common_cells cdc_fifo_2phase.sv]] \
    [file normalize [file join $repo_root ips common_cells cdc_fifo_gray.sv]] \
    [file normalize [file join $repo_root ips common_cells rr_arb_tree.sv]] \
    [file normalize [file join $repo_root ips common_cells stream_arbiter.sv]] \
    [file normalize [file join $repo_root ips common_cells stream_arbiter_flushable.sv]] \
    [file normalize [file join $repo_root ips common_cells sync.sv]] \
]
...
set bitstream_path [file normalize "./kraken_func_a7.runs/impl_1/kraken_soc_func_fpga.bit"]
